...
public class JiraInjection {
    ...
    public void pullIssues() throws IOException, URISyntaxException {
        ...
        do {
            ...
            //classe util: to create a JSON from a public URL
            ...
            for (; i < total && i < j; i++) {
                ...
                if (openingVersion != null && fixedVersion != null && openingVersion.getId() != this.releases.getFirst().getId()) {
    ...
    public void setTicketsWithIssues(List<Ticket> ticketsWithIssues) {
        this.ticketsWithIssues = ticketsWithIssues;
    }
    ...
    public void setFixedTickets(List<Ticket> fixedTickets) {
