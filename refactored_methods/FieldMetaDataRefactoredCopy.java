...
public class FieldMetaDataRefactoredCopy
        extends Extensions
     ...
     */
    protected FieldMetaDataRefactoredCopy(String name, Class<?> type, ClassMetaData owner) {
        _name = name;
        _owner = owner;
        _dec = null;
        _decMeta = null;
